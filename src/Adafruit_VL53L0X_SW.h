...
#ifndef ADAFRUIT_VL53L0X_SW_H
#define ADAFRUIT_VL53L0X_SW_H
...
public:
  ...
  boolean begin(TwoWire *i2c);
  boolean begin(SoftWire *softWire);
  boolean begin(uint8_t i2c_addr, TwoWire *i2c);
  boolean begin(uint8_t i2c_addr, SoftWire *softWire);
